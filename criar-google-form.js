// Script para criar automaticamente o Google Form
// Execute este script no Google Apps Script

function criarFormularioPresentes() {
...
// Função para obter IDs dos campos
function obterIdsCampos() {
  var form = FormApp.openById('SEU_FORM_ID'); // Substitua pelo ID do seu formulário
